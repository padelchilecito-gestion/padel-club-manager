...
const { parseISO, parse, addMinutes, startOfDay, endOfDay } = require('date-fns');
...
const createBooking = async (req, res) => {
  ...
  try {
    ...
    // ✅ Usar fromZonedTime en lugar de zonedTimeToUtc
    ...
    if (conflictingBooking) {
        console.warn('Conflicto de reserva:', { conflictingBooking });

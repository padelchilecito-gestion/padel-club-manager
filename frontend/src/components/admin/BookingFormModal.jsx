          ...
          <div className="grid grid-cols-2 gap-4">
           ...
           <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="number" name="price" value={formData.price} onChange={handleChange} required min="0" className="w-full mt-1 bg-dark-primary p-2 rounded-md border border-gray-600" />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
